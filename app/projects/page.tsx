...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-default-50 ">
      <div className="">
        <div className=" bg-background rounded-b-[5rem]">
          <div className="relative p-20 pt-32 container mx-auto ">
            ...
            >
              Interessado no que podemos fazer por você? Confira algumas de
              nossas histórias de sucesso e como transformamos ideias iniciais
        ...
        <motion.div
          animate="visible"
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 container mx-auto py-28"
          initial="hidden"
          ...
          <div className="max-w-5xl mx-auto bg-background rounded-3xl p-12 relative overflow-hidden flex flex-col">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-lg px-2 mb-8">
                Você pode ser nossa próxima história de sucesso! Seja um design
                de website, estratégia SEO, campanha no Google Ads ou algo mais,
